...
# kli multisig incept --name extgar1 --alias extgar1 --group "External GAR" --file ${KERI_DEMO_SCRIPT_DIR}/data/ext-gar-incept.json
# kli multisig incept --name extgar2 --alias extgar2 --group "External GAR" --file ${KERI_DEMO_SCRIPT_DIR}/data/ext-gar-incept.json
